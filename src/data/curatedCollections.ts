...
export const curatedCollectionsData: CollectionCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { type: 'album', title: 'Is anybody out there?', artist: 'Allie X', releaseDate: '2025-09', description: '', link: 'https://music.apple.com/de/album/is-anybody-out-there-single/1834662893' },
      ...
      { type: 'album', title: 'DEAD', artist: 'Sudan Archives', releaseDate: '2025-06', description: '', link: 'https://music.apple.com/de/album/dead-single/1813467643' },
